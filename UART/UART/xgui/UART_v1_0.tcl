...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "RX_FIFO_DATA_WIDTH" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "RX_FIFO_DEPTH" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "TX_FIFO_DATA_WIDTH" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "TX_FIFO_DEPTH" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "UART_DATA_WIDTH" -parent ${Page_0} -widget comboBox
